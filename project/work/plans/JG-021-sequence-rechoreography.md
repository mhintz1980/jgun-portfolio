...
**Status:** in-progress (materials round 3 implemented 2026-08-30 — owner visual ruling pending, not pushed; evidence §11: baked palette retained per owner ruling, panels 0.35/0.18, Station-2-scoped IBL crossfade) · **Accepted:** 2026-08-28 · **Amended:** 2026-08-29 (Amendment A) · **Reopened:** 2026-08-29 — owner visual pass failed framing, material look, and GD&T symbol styling; see the Visual Pass Findings section in the evidence record. · **Origin:** root-cause review by a remote agent (supplied by Mark Hintz), verified against the committed baseline `5b29706 → 4a10491` and adopted with the corrections below. All line references are against that committed baseline, which is current again after the 2026-08-28 tree repair.
