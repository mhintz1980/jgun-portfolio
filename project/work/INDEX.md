...
| JG-023 | in-progress (built + verified 2026-08-31 via orchestrated /unlazy: AC 1-8 green, adversarial layer complete — AC 9 owner ruling PENDING: pilot CH.01 armed, /?chapter=0; CH.03 = one-const flip of `BACKDROP_CHAPTER_FLAGS[2]`. Local commits `bc76efc..4cffd36`, unpushed pending Mark's review) | Scroll-scrubbed procedural backdrop layers — per-chapter camera-locked GL backdrops behind all three stations, `SCRUBBED_BACKGROUNDS` flag, bloom < 0.6 linear-luminance gate (measured 0.032433), zero media payload, +6,285 B min JS | [Queued](../../TODO.md#queued) | [plan](plans/JG-023-scrubbed-backgrounds.md) · [roster](plans/JG-023-scrubbed-backgrounds-skill-roster.md) | [evidence](evidence/JG-023-scrubbed-backgrounds-verification.md) |
