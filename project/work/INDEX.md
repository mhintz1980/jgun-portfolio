...
| JG-024 | implemented + machine-verified 2026-09-02 (evidence: ladder byte-identical, screws = `fastener` unit `#0d0d0d` 383 K tris, perf 16.8 ms quantum, CH.04 pixel-diff localized at the back plate) — **owner visual ruling pending** | Fine-tessellation JGun re-export with missing fasteners — gltf-transform simplify+Draco (13.73 MB / 1.29 M tris), 9 handle screws, `fastener` rig unit + `blackOxideSteel` default | [Queued](../../TODO.md#queued) | [plan](plans/JG-024-fine-jgun-fastener-reswap.md) | [evidence](evidence/JG-024-fine-jgun-fastener-reswap-verification.md) |
