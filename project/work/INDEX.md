...
| JG-021 | in-progress (re-review 2026-08-30: runout+framing pass, materials round 2 open — not pushed) | Sequence re-choreography: camera continuity, enclosure material & animation, callout safe-area placement — REOPENED 2026-08-29 (owner visual pass), remediation §9; re-review §10: blowout fixed but enclosure color assignment still wrong — diagnose from `evidence/JG-021-review-2026-08-30-st2-materials.png` | [Queued](../../TODO.md#queued) | [plan](plans/JG-021-sequence-rechoreography.md) | [evidence](evidence/JG-021-sequence-rechoreography-verification.md) |
