...
|---|---|---|---|
| **P0 Orient** | Every session start | `codebase-memory` only if a graph query is needed | TODO.md + INDEX.md + linked plan read; git state checked; parallel-session contamination check (`.scratch/`, `docs/orzo-*`) |
